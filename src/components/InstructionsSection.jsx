  ...
  return (
    <section className="instructions-section">
      <div className="section-title">
        <RiInformationLine style={{ color: '#36D1DC' }} />
        <h2>使用说明</h2>
      </div>
      ...
      <div className="feature-list">
        <div className="feature-item">
          <RiCheckboxCircleLine style={{ color: '#36D1DC' }} />
      ...
      <div className="steps-list">
        <div className="step-item">
          <div className="step-number" style={{ backgroundColor: 'rgba(54, 209, 220, 0.1)', color: '#36D1DC' }}>1</div>
          <div style={{ color: 'var(--text-secondary)', textAlign: 'left' }}>请访问 Google AI 申请独立 Gemini API Key，填入系统右上角的设置中</div>
        </div>
        <div className="step-item">
          <div className="step-number" style={{ backgroundColor: 'rgba(54, 209, 220, 0.1)', color: '#36D1DC' }}>2</div>
          <div style={{ color: 'var(--text-secondary)', textAlign: 'left' }}>点击选择文件上传音频，建议是音频格式 mp3、wav 等，也支持 MP4</div>
        </div>
        <div className="step-item">
          <div className="step-number" style={{ backgroundColor: 'rgba(54, 209, 220, 0.1)', color: '#36D1DC' }}>3</div>
          <div style={{ color: 'var(--text-secondary)', textAlign: 'left' }}>等待系统分析完成，通常 20-30s</div>
        </div>
        <div className="step-item">
          <div className="step-number" style={{ backgroundColor: 'rgba(54, 209, 220, 0.1)', color: '#36D1DC' }}>4</div>
